    ...
    public static int func_146034_e(EntityFishHook instance) {
        if (instance.worldObj.isRemote)
            ...
            if (instance.field_146043_c != null) {
                ...
                b0 = 3;
                // TODO: instance.field_146045_ax <- 1
            } else if (1 > 0) {
                // TODO: instance.func_146033_f() <- null
                ItemStack catchStack = null;
                // NullPo crash fix
                if (catchStack != null) {
                    ...
                    instance.field_146042_b.worldObj.spawnEntityInWorld(new EntityXPOrb(
                            ...
                            + 0.5D, instance.field_146042_b.posZ + 0.5D, new Random().nextInt(6) + 1));
                    b0 = 1;
                }
            }
            // TODO: instance.field_146051_au <- true
            if (true)
                b0 = 2;
            instance.setDead();
