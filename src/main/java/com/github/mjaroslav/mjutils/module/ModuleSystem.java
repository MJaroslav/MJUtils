package com.github.mjaroslav.mjutils.module;
 ...
 * @see Modular
 * @see Proxy
 * @see Initializator.Configurable
...
public class ModuleSystem {
    ...
    private final Set<Initializator.Configurable> configurations = new HashSet<>();
     ...
     * @param customConfigurations see {@link Initializator.Configurable}. Can be empty or null.
     */
    public ModuleSystem(String modID, FileBasedConfiguration config, Proxy proxy,
                        Initializator.Configurable... customConfigurations) {
        this.modID = modID;
        this.config = config;
        this.proxy = proxy;
    ...
    private void constuct(FMLConstructionEvent event) {
        ...
        for (Initializator.Configurable config : configurations)
            config.construct(event);
