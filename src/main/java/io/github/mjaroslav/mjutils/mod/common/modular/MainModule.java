...
import io.github.mjaroslav.mjutils.mod.client.listener.ClientEventListener;
import io.github.mjaroslav.mjutils.mod.common.handler.BlockEventListener;
            ...
            if (Proxy.isClient()) { // Separate client messages for NoClassFound dodging.
                if ("disable_block_destroying_in_creative".equals(message.key)) {
                    if (message.isItemStackMessage())
                        ClientEventListener.INSTANCE.extraDisabledForCreativeDestroying
