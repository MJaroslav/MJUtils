...
public class ModInfo {
    ...
    public static final String guiFactory = "io.github.mjaroslav.mjutils.mod.client.gui.GUIFactory";

    public static final String clientProxy = "io.github.mjaroslav.mjutils.mod.client.ClientProxy";
    public static final String serverProxy = "io.github.mjaroslav.mjutils.mod.server.ServerProxy";
