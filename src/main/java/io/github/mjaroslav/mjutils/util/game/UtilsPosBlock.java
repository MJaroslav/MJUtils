...
public class UtilsPosBlock {
    public boolean getBlocksMovement(@NotNull Block owner, @NotNull IBlockAccess world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos) {
        return owner.getBlocksMovement(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue());
    }

    public float getBlockHardness(@NotNull Block owner, @NotNull World world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos) {
    ...
    @SideOnly(Side.CLIENT)
    public boolean shouldSideBeRendered(@NotNull Block owner, @NotNull IBlockAccess world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos,
                                        int side) {
        return owner.shouldSideBeRendered(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue(),
            side);
    }

    public boolean isBlockSolid(@NotNull Block owner, @NotNull IBlockAccess world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos,
                                int side) {
        return owner.isBlockSolid(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue(), side);
    }

    @SideOnly(Side.CLIENT)
    public IIcon getIcon(@NotNull Block owner, @NotNull IBlockAccess world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos, int meta) {
        return owner.getIcon(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue(), meta);
    }

    @SuppressWarnings("rawtypes")
    public void addCollisionBoxesToList(@NotNull Block owner, @NotNull World world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos,
    ...
    public void updateTick(@NotNull Block owner, @NotNull World world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos,
                           @NotNull Random rand) {
        owner.updateTick(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue(), rand);
    }

    @SideOnly(Side.CLIENT)
    public void randomDisplayTick(@NotNull Block owner, @NotNull World world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos,
                                  @NotNull Random rand) {
        owner.randomDisplayTick(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue(), rand);
    }

    public void onNeighborBlockChange(@NotNull Block owner, @NotNull World world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos,
                                      @NotNull Block block) {
        owner.onNeighborBlockChange(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue(), block);
    }

    public void onBlockAdded(@NotNull Block owner, @NotNull World world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos) {
        owner.onBlockAdded(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue());
    }

    public void breakBlock(@NotNull Block owner, @NotNull World world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos, @NotNull Block block,
                           int meta) {
    ...
    public void dropBlockAsItem(@NotNull Block owner, @NotNull World world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos, int meta,
                                int fortune) {
        owner.dropBlockAsItem(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue(), meta, fortune);
    }

    public void dropBlockAsItemWithChance(@NotNull Block owner, @NotNull World world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos,
    ...
    public void dropBlockAsItem(@NotNull Block owner, @NotNull World world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos,
                                @NotNull ItemStack stack) {
        ((AccessorBlock) owner).invokeDropBlockAsItem(world, pos.getX().intValue(), pos.getY().intValue(),
            pos.getZ().intValue(), stack);
    }

    public void dropXpOnBlockBreak(@NotNull Block owner, @NotNull World world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos, int xp) {
    ...
    public MovingObjectPosition collisionRayTrace(@NotNull Block owner, @NotNull World world,
                                                  @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos, @NotNull Vec3 startVec,
                                                  @NotNull Vec3 endVec) {
        return owner.collisionRayTrace(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue(), startVec, endVec);
    }

    public void onBlockDestroyedByExplosion(@NotNull Block owner, @NotNull World world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos,
                                            @NotNull Explosion explosion) {
        owner.onBlockDestroyedByExplosion(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue(),
            explosion);
    }

    public boolean canReplace(@NotNull Block owner, @NotNull World world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos,
    ...
    public boolean canPlaceBlockOnSide(@NotNull Block owner, @NotNull World world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos,
    ...
    public boolean canPlaceBlockAt(@NotNull Block owner, @NotNull World world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos) {
        return owner.canPlaceBlockAt(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue());
    }

    public boolean onBlockActivated(@NotNull Block owner, @NotNull World world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos,
    ...
    public void onEntityWalking(@NotNull Block owner, @NotNull World world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos,
                                @NotNull Entity entity) {
        owner.onEntityWalking(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue(), entity);
    }

    public int onBlockPlaced(@NotNull Block owner, @NotNull World world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos,
                             @NotNull ForgeDirection direction, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> hit, int meta) {
    ...
    public void onBlockClicked(@NotNull Block owner, @NotNull World world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos,
                               @NotNull EntityPlayer player) {
        owner.onBlockClicked(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue(), player);
    }

    public void velocityToAddToEntity(@NotNull Block owner, @NotNull World world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos,
                                      @NotNull Entity entity, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> velocity) {
    ...
    @SideOnly(Side.CLIENT)
    public int colorMultiplier(@NotNull Block owner, @NotNull IBlockAccess world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos) {
        return owner.colorMultiplier(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue());
    }

    public int isProvidingWeakPower(@NotNull Block owner, @NotNull IBlockAccess world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos,
                                    @NotNull ForgeDirection direction) {
        return owner.isProvidingWeakPower(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue(),
            direction.ordinal());
    }

    public void onEntityCollidedWithBlock(@NotNull Block owner, @NotNull World world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos,
                                          @NotNull Entity entity) {
        owner.onEntityCollidedWithBlock(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue(),
            entity);
    }

    public int isProvidingStrongPower(@NotNull Block owner, @NotNull IBlockAccess world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos,
                                      @NotNull ForgeDirection direction) {
    ...
    public boolean canBlockStay(@NotNull Block owner, @NotNull World world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos) {
        return owner.canBlockStay(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue());
    }

    public void onBlockPlacedBy(@NotNull Block owner, @NotNull World world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos,
    ...
    public void onPostBlockPlaced(@NotNull Block owner, @NotNull World world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos, int meta) {
        owner.onPostBlockPlaced(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue(), meta);
    }

    public boolean onBlockEventReceived(@NotNull Block owner, @NotNull World world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos,
                                        int event, int parameter) {
        return owner.onBlockEventReceived(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue(),
            event, parameter);
    }

    public void onFallenUpon(@NotNull Block owner, @NotNull World world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos,
    ...
    @SideOnly(Side.CLIENT)
    public Item getItem(@NotNull Block owner, @NotNull World world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos) {
        return owner.getItem(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue());
    }

    public int getDamageValue(@NotNull Block owner, @NotNull World world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos) {
        return owner.getDamageValue(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue());
    }

    public void onBlockHarvested(@NotNull Block owner, @NotNull World world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos, int meta,
                                 @NotNull EntityPlayer harvester) {
        owner.onBlockHarvested(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue(), meta,
            harvester);
    }

    public void onBlockPreDestroy(@NotNull Block owner, @NotNull World world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos, int meta) {
        owner.onBlockPreDestroy(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue(), meta);
    }

    public void fillWithRain(@NotNull Block owner, @NotNull World world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos) {
        owner.fillWithRain(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue());
    }

    public int getComparatorInputOverride(@NotNull Block owner, @NotNull World world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos,
                                          @NotNull ForgeDirection direction) {
        return owner.getComparatorInputOverride(world, pos.getX().intValue(), pos.getY().intValue(),
            pos.getZ().intValue(), direction.ordinal());
    }

    public int getLightValue(@NotNull Block owner, @NotNull IBlockAccess world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos) {
        return owner.getLightValue(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue());
    }

    public boolean isLadder(@NotNull Block owner, @NotNull IBlockAccess world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos,
                            @NotNull EntityLivingBase entity) {
        return owner.isLadder(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue(), entity);
    }

    public boolean isNormalCube(@NotNull Block owner, @NotNull IBlockAccess world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos) {
        return owner.isNormalCube(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue());
    }

    public boolean isSideSolid(@NotNull Block owner, @NotNull IBlockAccess world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos,
                               @NotNull ForgeDirection direction) {
        return owner.isSideSolid(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue(), direction);
    }

    public boolean isReplaceable(@NotNull Block owner, @NotNull IBlockAccess world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos) {
        return owner.isReplaceable(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue());
    }

    public boolean isBurning(@NotNull Block owner, @NotNull IBlockAccess world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos) {
        return owner.isBurning(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue());
    }

    public boolean isAir(@NotNull Block owner, @NotNull IBlockAccess world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos) {
    ...
    public boolean removedByPlayer(@NotNull Block owner, @NotNull World world, @NotNull EntityPlayer player,
                                   @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos, boolean willHarvest) {
    ...
    public int getFlammability(@NotNull Block owner, @NotNull IBlockAccess world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos,
                               @NotNull ForgeDirection face) {
        return owner.getFlammability(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue(), face);
    }

    public boolean isFlammable(@NotNull Block owner, @NotNull IBlockAccess world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos,
                               @NotNull ForgeDirection face) {
        return owner.isFlammable(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue(), face);
    }

    public int getFireSpreadSpeed(@NotNull Block owner, @NotNull IBlockAccess world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos,
                                  @NotNull ForgeDirection face) {
        return owner.getFireSpreadSpeed(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue(),
            face);
    }

    public boolean isFireSource(@NotNull Block owner, @NotNull World world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos,
                                @NotNull ForgeDirection side) {
        return owner.isFireSource(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue(), side);
    }

    public ArrayList<ItemStack> getDrops(@NotNull Block owner, @NotNull World world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos,
    ...
    public boolean canSilkHarvest(@NotNull Block owner, @NotNull World world, @NotNull EntityPlayer player,
                                  @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos, int metadata) {
    ...
    public boolean isBed(@NotNull Block owner, @NotNull IBlockAccess world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos,
    ...
    public void setBedOccupied(@NotNull Block owner, @NotNull IBlockAccess world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos,
    ...
    public int getBedDirection(@NotNull Block owner, @NotNull IBlockAccess world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos) {
        return owner.getBedDirection(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue());
    }

    public boolean isBedFoot(@NotNull Block owner, @NotNull IBlockAccess world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos) {
        return owner.isBedFoot(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue());
    }

    public void beginLeavesDecay(@NotNull Block owner, @NotNull World world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos) {
        owner.beginLeavesDecay(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue());
    }

    public boolean canSustainLeaves(@NotNull Block owner, @NotNull IBlockAccess world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos) {
        return owner.canSustainLeaves(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue());
    }

    public boolean isLeaves(@NotNull Block owner, @NotNull IBlockAccess world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos) {
    ...
    public boolean isWood(@NotNull Block owner, @NotNull IBlockAccess world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos) {
        return owner.isWood(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue());
    }

    public boolean isReplaceableOreGen(@NotNull Block owner, @NotNull World world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos,
    ...
    public float getExplosionResistance(@NotNull Block owner, @NotNull Entity entity, @NotNull World world,
                                        @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> explosionPos) {
    ...
    public void onBlockExploded(@NotNull Block owner, @NotNull World world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos,
                                @NotNull Explosion explosion) {
        owner.onBlockExploded(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue(), explosion);
    }

    public boolean canConnectRedstone(@NotNull Block owner, @NotNull IBlockAccess world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos,
                                      @NotNull ForgeDirection direction) {
    ...
    public ItemStack getPickBlock(@NotNull Block owner, MovingObjectPosition target, @NotNull World world,
                                  @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos, @NotNull EntityPlayer player) {
    ...
    public boolean isFoliage(@NotNull Block owner, @NotNull IBlockAccess world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos) {
        return owner.isFoliage(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue());
    }

    @SideOnly(Side.CLIENT)
    public boolean addDestroyEffects(@NotNull Block owner, @NotNull World world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos, int meta,
    ...
    public boolean canSustainPlant(@NotNull Block owner, @NotNull IBlockAccess world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos,
    ...
    public void onPlantGrow(@NotNull Block owner, @NotNull World world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos,
    ...
    public boolean isFertile(@NotNull Block owner, @NotNull World world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos) {
        return owner.isFertile(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue());
    }

    public int getLightOpacity(@NotNull Block owner, @NotNull IBlockAccess world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos) {
        return owner.getLightOpacity(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue());
    }

    public boolean canEntityDestroy(@NotNull Block owner, @NotNull IBlockAccess world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos,
                                    @NotNull Entity entity) {
        return owner.canEntityDestroy(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue(),
            entity);
    }

    public boolean isBeaconBase(@NotNull Block owner, @NotNull IBlockAccess world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos,
    ...
    public boolean rotateBlock(@NotNull Block owner, @NotNull World world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos,
                               @NotNull ForgeDirection axis) {
        return owner.rotateBlock(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue(), axis);
    }

    public ForgeDirection[] getValidRotations(@NotNull Block owner, @NotNull World world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos) {
        return owner.getValidRotations(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue());
    }

    public float getEnchantPowerBonus(@NotNull Block owner, @NotNull World world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos) {
        return owner.getEnchantPowerBonus(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue());
    }

    public boolean recolourBlock(@NotNull Block owner, @NotNull World world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos,
    ...
    public void onNeighborChange(@NotNull Block owner, @NotNull IBlockAccess world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos,
    ...
    public boolean shouldCheckWeakPower(@NotNull Block owner, @NotNull IBlockAccess world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos,
                                        @NotNull ForgeDirection direction) {
        return owner.shouldCheckWeakPower(world, pos.getX().intValue(), pos.getY().intValue(), pos.getZ().intValue(),
            direction.ordinal());
    }

    public boolean getWeakChanges(@NotNull Block owner, @NotNull IBlockAccess world, @NotNull Triplet<? extends Number, ? extends Number, ? extends Number> pos) {
