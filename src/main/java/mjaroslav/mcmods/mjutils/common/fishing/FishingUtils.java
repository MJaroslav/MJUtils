...
public class FishingUtils {
     ...
     *
     * @param itemStack    - itemStack that should be removed.
     * @param checkOnEmpty - add default itemStack if category is empty (empty list
     ...
     *
     * @param itemStack    - itemStack that should be removed.
     * @param category     - category from which itemStack should be deleted.
     * @param checkOnEmpty - add default itemStack if category is empty (empty list
     *                     causes crash).
     */
     ...
     *
     * @param itemStack - itemStack that should be added.
     * @param weight    - rarity of itemStack (You can use
     ...
     * @param category  - category in which the itemStack should be added.
     */
     ...
     *
     * @param category - category to receive.
    ...
    public static ArrayList<WeightedRandomFishable> getCategory(FishableCategory category) {
        try {
            switch (category) {
                case FISH:
                    return (ArrayList<WeightedRandomFishable>) ((ArrayList<WeightedRandomFishable>) getPrivateValue(FishingHooks.class, new FishingHooks(), "fish")).clone();
                case JUNK:
                    return (ArrayList<WeightedRandomFishable>) ((ArrayList<WeightedRandomFishable>)
                            getPrivateValue(FishingHooks.class, new FishingHooks(), "junk")).clone();
                case TREASURE:
                    return (ArrayList<WeightedRandomFishable>) ((ArrayList<WeightedRandomFishable>) getPrivateValue(FishingHooks.class, new FishingHooks(), "treasure")).clone();
            }
        } catch (Exception e) {
        }
     ...
     *
     * @param category    - category to be cleared.
     * @param addDefaults - add default itemStack if category is empty (empty list
     *                    causes crash).
     */
