...
public class AnvilUtils {
   ...
   * Add recipe.
   *
   * @param result - result from crafting (with cost).
   * @param recipe - anvil recipe.
   */
   ...
   *
   * @param left - left slot item.
   * @param right - right slot item.
   * @param name - text field of anvil.
