...
public class AnvilRecipe {
  ...
  /**
   * Name of left stack in lower case without spaces. If the string is empty, it
   * is ignored.
   */
  ...
  /**
   * The price of the recipe in the levels. If it is zero, the price will always
   * be equal to one, not counting the quantity.
   */
  public int cost;
