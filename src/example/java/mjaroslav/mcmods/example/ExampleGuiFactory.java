...
public class ExampleGuiFactory implements IModGuiFactory {
  ...
  public static class ExampleGuiScreen extends GuiConfig {
    public ExampleGuiScreen(GuiScreen parentScreen) {
      super(parentScreen, new ConfigElement(ExampleMod.config.getInstance().getCategory(ExampleConfig.categoryExample))
          .getChildElements(), ExampleInfo.MODID, false, false, "config/" + ExampleInfo.MODID + ".cfg");
