...
public class ExampleModule implements IModModule {
  ...
  public void init(FMLInitializationEvent event) {
    ...
    AnvilUtils.addRecipe(new ItemStack(Items.nether_star, 1), new AnvilRecipe(new ItemStack(Blocks.diamond_block, 1),
        new ItemStack(Items.skull, 4, 1), "core", "", "netherstar", 30));
    // Register compass to junk type of fishing catch with default rarity.
    FishingUtils.addItemToCategory(new ItemStack(Items.compass, 1), FishingConstants.rarityJunk, FishableCategory.JUNK);
