...
import mjaroslav.mcmods.mjutils.common.anvil.UtilsAnvil;
import mjaroslav.mcmods.mjutils.common.fishing.UtilsFishing;
import mjaroslav.mcmods.mjutils.common.objects.IModModule;
import mjaroslav.mcmods.mjutils.common.objects.ModInitModule;
import mjaroslav.mcmods.mjutils.common.reaction.UtilsReaction;
...
public class ExampleModule implements IModModule {
    ...
    public void init(FMLInitializationEvent event) {
        ...
        UtilsAnvil.addRecipe(new ItemStack(Items.nether_star, 1),
        ...
        UtilsFishing.addItemToCategory(new ItemStack(Items.compass, 1), FishingConstants.rarityJunk,
                FishableCategory.JUNK);
        // Register quartz ore in pig zombie 'angry blocks'.
        UtilsReaction.addBlockToPigAngryList(Blocks.quartz_ore, OreDictionary.WILDCARD_VALUE);
